        ...
        <body className="min-h-screen flex flex-col relative overflow-x-hidden bg-background text-foreground">
          ...
          >
            <div className="absolute -z-10 w-full h-full overflow-hidden">
              <div className="absolute top-[-10rem] left-[-5rem] w-[25rem] h-[25rem] bg-purple-300 dark:bg-purple-800 opacity-30 rounded-full filter blur-3xl animate-blob delay-2000" />
              <div className="absolute bottom-[-10rem] right-[-5rem] w-[30rem] h-[30rem] bg-blue-300 dark:bg-blue-800 opacity-30 rounded-full filter blur-3xl animate-blob delay-4000" />
