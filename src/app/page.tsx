  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8">
      <div className="relative w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl">
        ...
        />
        <div className="absolute inset-0 bg-[rgba(0,0,0,0.5)] rounded-lg"></div>
        <h1 className="absolute inset-0 flex items-center justify-center text-2xl sm:text-3xl md:text-4xl font-bold text-center text-white drop-shadow-2xl rounded-lg p-4 sm:p-6">
          Ucz się React.js z AI
        </h1>
      </div>

      <div className="w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl p-4 sm:p-6 md:p-8 rounded-lg">
        <Questions
          onQuestionChange={setCurrentQuestion}
          setRecordingTime={setRecordingTime}
          isRecording={isRecording}
        ...
        {currentQuestion && (
          <div className="mt-4 sm:mt-6 p-4 sm:p-6 rounded-lg">
            <h3 className="text-base sm:text-lg md:text-xl mb-2 sm:mb-4 text-center">
